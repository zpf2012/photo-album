...
window.onload = function(){
    ...
    for(var i = 0 ; i < imgArr.length; i++){
        var currImg = imgArr[i];
        console.log(currImg.clientHeight, currImg.clientWidth);
        if(currImg.clientWidth >= currImg.clientHeight){
            currImg.style.width = 'auto';
            currImg.style.height = '100%';
        }else {
            currImg.style.width = '100%';
            currImg.style.height = 'auto';
        }
    }
}
